const en = {
    ...
    searchMailPlaceholder: 'Search sender, subject, content, or attachments',
    searchKeywordRequired: 'Enter a search keyword',
    closeSearch: 'Close search',
    searchResultsFor: 'Search results for “{keyword}”',
    deleteForeverConfirm: 'These messages and attachments will be permanently deleted. Continue?',
    rulesAndLabels: 'Rules & Labels',
    labels: 'Labels',
    labelsDesc: 'Create recognizable categories for messages',
    manageLabels: 'Manage labels',
    createLabelFirst: 'Create a label in Rules & Labels first',
    labelName: 'Label name',
    noLabels: 'No labels yet',
    mailRules: 'Inbox Rules',
    mailRulesDesc: 'Automatically act on newly received messages',
    addRule: 'Add Rule',
    editRule: 'Edit Rule',
    ruleName: 'Rule name',
    condition: 'Condition',
    ...
    priority: 'Priority',
    deleteLabelConfirm: 'Rules using this label will also be deleted. Continue?',
    deleteRuleConfirm: 'Delete this rule?',
    completeRuleForm: 'Complete the rule name and match value',
    settings: 'Settings',
    analytics: 'Analytics',
    allUsers: 'All Users',
    allMail: 'All Mail',
    ...
    syncDeleteDesc: 'When enabled, delete actions bypass Trash and permanently remove messages immediately.',
    trashRetention: 'Trash retention days',
    trashRetentionDesc: 'Messages and attachments older than this are purged by the daily task.',
    adminViewEmail: 'Allow admins to view all mail',
    adminViewEmailDesc: 'When enabled, admins can read message content in All Mail and every signed-in user receives a privacy notice. Disabling it blocks access in both the UI and API.',
    mailPrivacyNoticeTitle: 'Email privacy notice',
    mailPrivacyNoticeContent: 'Service administrators can read message content through system management. Do not use this mailbox for passwords, identity documents, financial records, or other sensitive information.',
    ...
    upstreamProject: 'Upstream GitHub',
    copyright: 'Copyright',
    upstreamAttribution: 'Based on the open-source Cloud Mail © 2025 eoao project',
    community: 'Community',
    ...
    supportQianL: 'Support QianL Mail',
    supportUpstream: 'Support upstream author',
    donationTitle: 'Support QianL Mail',
    donationQrAlt: 'QianL Mail WeChat Pay and Alipay donation QR codes',
    donationNotice: 'Thank you. Verify the recipient and amount before paying. These codes are for voluntary donations only.',

const zh = {
    ...
    trash: '回收站',
    searchMail: '搜索邮件',
    searchMailPlaceholder: '搜索发件人、主题、正文或附件',
    searchKeywordRequired: '请输入搜索关键词',
    closeSearch: '收起搜索',
    searchResultsFor: '“{keyword}”的搜索结果',
    deleteForeverConfirm: '这些邮件及其附件将被永久删除，且无法恢复，是否继续？',
    rulesAndLabels: '规则与标签',
    labels: '标签',
    labelsDesc: '给邮件添加易于识别的分类',
    manageLabels: '管理标签',
    createLabelFirst: '请先在“规则与标签”中创建标签',
    labelName: '标签名称',
    noLabels: '还没有标签',
    mailRules: '收件规则',
    mailRulesDesc: '收到新邮件时自动执行操作',
    addRule: '添加规则',
    editRule: '编辑规则',
    ruleName: '规则名称',
    condition: '匹配条件',
    ...
    selectLabel: '选择标签',
    priority: '优先级',
    deleteLabelConfirm: '删除标签后，使用该标签的规则也会被删除，是否继续？',
    deleteRuleConfirm: '确认删除这条规则？',
    completeRuleForm: '请填写完整的规则名称和匹配内容',
    settings: '个人设置',
    analytics: '分析页',
    allUsers: '用户列表',
    allMail: '全部邮件',
    ...
    loginDomain: '隐藏登录域名',
    syncDelete: '同步删除',
    syncDeleteDesc: '开启后删除操作会跳过回收站并立即永久删除',
    trashRetention: '回收站保留天数',
    trashRetentionDesc: '每日定时清理超过保留期的邮件及附件',
    adminViewEmail: '允许管理员查看全部邮件',
    adminViewEmailDesc: '开启后管理员可在“全部邮件”中查看邮件内容，所有登录用户将收到隐私提示；关闭后前后端均禁止访问',
    mailPrivacyNoticeTitle: '邮件隐私提示',
    mailPrivacyNoticeContent: '本服务管理员可通过系统管理查看邮件内容。请勿使用本邮箱收发密码、身份证件、财务资料等敏感信息。',
    multipleEmail: '多号模式',
    ...
    upstreamProject: '原项目 GitHub',
    copyright: '版权',
    upstreamAttribution: '基于 Cloud Mail © 2025 eoao 开源项目',
    community: '交流',
    changeTitle: '修改标题',
    ...
    support: '捐助',
    supportDesc: '请我喝杯奶茶',
    supportQianL: '支持 QianL Mail',
    supportUpstream: '支持原项目作者',
    donationTitle: '支持 QianL Mail',
    donationQrAlt: 'QianL Mail 微信和支付宝收款码',
    donationNotice: '感谢支持。付款前请核对收款人与金额，二维码仅用于自愿捐助。',
    featDesc: '功能说明',
